        ...
        <div class="card">
            <div class="card-header with-border">
                ...
                <div class="card-tools pull-right">
                    <a href="{{route('libro-prestamo.crear')}}" class="btn btnoutline-secondary btn-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center"><img
                                    src="{{Storage::url("imagenes/caratulas/" . $data->libro->foto)}}"
                                    alt="caratula del libro" style="width:50px"></td>
                            ...
                            <td>
                                ...
                                <a href="{{route('libro-prestamo.devolver', $data->libro->id)}}"
                                    class="libro-devolucion btn-accion-tabla tooltipsC" title="Devolver este libro">
