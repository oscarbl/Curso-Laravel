...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card card-danger">
            ...
            <form action="{{route('libro-prestamo.guardar')}}" id="form-general" class="form-horizontal" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="prestado_a" id="prestado_a" class="form-control"
                                value="{{old('prestado_a')}}" required />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="fecha_prestamo" class="col-lg-3 col-form-label requerido">fecha_prestamo</label>
                        <div class="col-lg-8">
                            <input type="text" name="fecha_prestamo" id="fecha_prestamo" class="form-control"
