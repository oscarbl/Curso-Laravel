...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input type="text" name="usuario" id="usuario" class="form-control"
            value="{{old('usuario', $data->usuario ?? '')}}" required />
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    <label for="re_password" class="col-lg-3 control-label {{!isset($data) ? 'requerido' : ''}}">Repita
        Contraseña</label>
    <div class="col-lg-8">
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <select name="rol_id" id="rol_id" class="form-control" required>
            ...
            <option value="{{$id}}" {{old("rol_id", $data->roles[0]->id ?? "") == $id ? "selected" : ""}}>{{$nombre}}
            </option>
            @endforeach
        </select>
    </div>
